...
import { idlFactory } from './ii_integration_backend.did.js';
export { idlFactory } from './ii_integration_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.II_INTEGRATION_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ii_integration_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ii_integration_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ii_integration_backend.did.js")._SERVICE>}
 */
export const ii_integration_backend = createActor(canisterId);
