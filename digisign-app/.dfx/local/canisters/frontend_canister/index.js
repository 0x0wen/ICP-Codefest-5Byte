...
import { idlFactory } from './frontend_canister.did.js';
export { idlFactory } from './frontend_canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.FRONTEND_CANISTER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./frontend_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the frontend_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./frontend_canister.did.js")._SERVICE>}
 */
export const frontend_canister = createActor(canisterId);
