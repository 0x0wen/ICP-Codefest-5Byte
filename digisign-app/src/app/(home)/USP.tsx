...
const USP = () => {
	return (
		<section id="usp" className="relative mt-28 mb-40">
			...
			<Image
				src={Plane}
				alt=""
				className="absolute top-0 right-20 -z-10 w-20"
			/>
			<h3 className="text-xl text-center mx-40">
				Harmonize your digital journey with seamless signature, unrivaled
				security, and tailored flexibility. Experience the symphony of
				DigiSignID.
			</h3>
			<section className="relative flex justify-center items-center mt-28">
				...
				/>
				<Image src={Robot} alt="" className="w-96" />
				<ul className="text-white space-y-8">
					<li className="bg-gradient-to-br from-color8 to-color4 shadow-xl drop-shadow-2xl  px-8 rounded-lg py-4 w-[30rem] ">
						<h4 className="text-lg font-semibold">Security Assurance</h4>
						<p className='text-sm'>
					...
					<li className="bg-gradient-to-br from-color8 to-color4 shadow-xl drop-shadow-2xl  px-8 rounded-lg py-4 w-[30rem] ml-20">
						<h4 className="text-lg font-semibold">Simplicity Redefined</h4>
						<p className='text-sm'>
					...
					<li className="bg-gradient-to-br from-color8 to-color4 shadow-xl drop-shadow-2xl  px-8 rounded-lg py-4 w-[30rem] ml-20">
						<h4 className="text-lg font-semibold">Effortless Batch Signing</h4>
						<p className='text-sm'>
					...
					<li className="bg-gradient-to-br from-color8 to-color4 shadow-xl drop-shadow-2xl  px-8 rounded-lg py-4 w-[30rem] ">
						<h4 className="text-lg font-semibold">Tailored Business Solutions</h4>
						<p className='text-sm'>
